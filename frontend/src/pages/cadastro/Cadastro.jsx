        ...
        <div className="login-content cadastro-content">
          ...
          <form className="login-forms">
            <div className="login-email">
              ...
              <input className="input-login" type="email" id="email" placeholder="Bruno Reginaldo dos Santos"/>
            </div>
            ...
            <div className="login-obs">
              <p>Já tem uma conta? <span className="login-cadastro">Fazer Login</span></p>
            </div>

            <div className="obs-termos">
              <p>Continuando, você aceitara nossos <span>Termos de serviços e Politica de privacidade</span></p>
            </div>
          </form>
