...
function InputOTPAnimatedNumber({ value }) {
  ...
  return (
    <MotionConfig reducedMotion="user">
      <motion.div
        ...
        className={cn(
          "group relative flex h-10 w-9 items-center justify-center rounded-[10px] border border-border bg-main-muted font-medium text-base text-[#FF8C00]",
